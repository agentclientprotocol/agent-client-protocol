...
<Note>
  ...
  [`schema/schema.v2.json`](https://github.com/agentclientprotocol/agent-client-protocol/blob/main/schema/schema.v2.json).
...
See protocol docs: [Cancellation](https://agentclientprotocol.com/protocol/v2/prompt-turn#cancellation)
...
See protocol docs: [Session Modes](https://agentclientprotocol.com/protocol/v2/session-modes)
...
See protocol docs: [Prompt Turn](https://agentclientprotocol.com/protocol/v2/prompt-turn)
...
See protocol docs: [User Message](https://agentclientprotocol.com/protocol/v2/prompt-turn#1-user-message)
...
See protocol docs: [Check for Completion](https://agentclientprotocol.com/protocol/v2/prompt-turn#4-check-for-completion)
...
See protocol docs: [Client](https://agentclientprotocol.com/protocol/v2/overview#client)
...
See protocol docs: [Terminals](https://agentclientprotocol.com/protocol/v2/terminals)
...
See protocol docs: [FileSystem](https://agentclientprotocol.com/protocol/v2/initialization#filesystem)
...
See protocol docs: [Stop Reasons](https://agentclientprotocol.com/protocol/v2/prompt-turn#stop-reasons)
...
See protocol docs: [Terminal](https://agentclientprotocol.com/protocol/v2/terminals)
...
See protocol docs: [Updating](https://agentclientprotocol.com/protocol/v2/tool-calls#updating)
