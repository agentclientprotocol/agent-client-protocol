...
<ResponseField name="_meta" type={"object | null"}>
  ACP extension metadata (not inner MCP params._meta); null is equivalent to
  omission.
</ResponseField>
...
<ResponseField
  name="requestId"
  type={<a href="#mcprequestid">McpRequestId</a>}
  required
>
...
<ResponseField
  name="serverId"
  type={<a href="#mcpserveracpid">McpServerAcpId</a>}
  required
>
