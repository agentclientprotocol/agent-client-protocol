...
See protocol docs: [Cancellation](https://agentclientprotocol.com/protocol/v2/draft/prompt-turn#cancellation)
...
See protocol docs: [Prompt Turn](https://agentclientprotocol.com/protocol/v2/draft/prompt-turn)
...
See protocol docs: [User Message](https://agentclientprotocol.com/protocol/v2/draft/prompt-turn#1-user-message)
...
See protocol docs: [Check for Completion](https://agentclientprotocol.com/protocol/v2/draft/prompt-turn#4-check-for-completion)
...
<ResponseField name="acpId" type={<a href="#mcpserveracpid">McpServerAcpId</a>} required>
...
See protocol docs: [Agent Reports Output](https://agentclientprotocol.com/protocol/v2/draft/prompt-turn#3-agent-reports-output)
...
<ResponseField name="id" type={<a href="#planid">PlanId</a>} required>
...
See protocol docs: [Stop Reasons](https://agentclientprotocol.com/protocol/v2/draft/prompt-turn#stop-reasons)
...
See protocol docs: [Updating](https://agentclientprotocol.com/protocol/v2/draft/tool-calls#updating)
