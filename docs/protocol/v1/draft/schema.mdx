...
<ResponseField name="requestId" type={<a href="#mcprequestid">McpRequestId</a>} required>
...
<ResponseField name="error" type={<a href="#mcperror">McpError</a>} required>
...
<ResponseField name="subagents" type={<><span><a href="#subagentcapabilities">SubagentCapabilities</a></span><span> | null</span></>} >
  **UNSTABLE**
...
<ResponseField name="notices" type={<><span><a href="#noticecapabilities">NoticeCapabilities</a></span><span> | null</span></>} >
  **UNSTABLE**
...
## <span class="font-mono">McpError</span>
...
## <span class="font-mono">McpRequestId</span>
...
## <span class="font-mono">NoticeCapabilities</span>
...
<ResponseField name="_meta" type={"object | null"}>
  The _meta property is reserved by ACP for additional metadata. Implementations
  MUST NOT make assumptions about values at these keys. Optional; omitted and
  `null` mean no metadata for this state snapshot.
</ResponseField>
...
## <span class="font-mono">SessionCancelCapabilities</span>
...
## <span class="font-mono">SessionReference</span>
...
<ResponseField
  ...
  required
>
  Identifier of the already-known session linked from this tool operation, not
  the session used to route the enclosing notification.
</ResponseField>
...
<ResponseField name="subagent_update" type="object">
**UNSTABLE**
...
<ResponseField name="capabilities" type={<><span><a href="#subagentsessioncapabilities">SubagentSessionCapabilities</a></span><span> | null</span></>} >
...
<ResponseField name="sessionUpdate" type={"string"} required>
  The discriminator value. Must be `"subagent_update"`.
</ResponseField>
<ResponseField name="state" type={<><span><a href="#stateupdate">StateUpdate</a></span><span> | null</span></>} >
...
<ResponseField name="state" type={"string"} required>
  The discriminator value. Must be `"unknown"`.
</ResponseField>
...
<ResponseField name="cancel" type={<><span><a href="#sessioncancelcapabilities">SessionCancelCapabilities</a></span><span> | null</span></>} >
...
## <span class="font-mono">SubagentUpdate</span>
...
<ResponseField name="type" type={"string"} required>
  The discriminator value. Must be `"session"`.
</ResponseField>
...
## <span class="font-mono">UnknownStateUpdate</span>
