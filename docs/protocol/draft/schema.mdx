...
<ResponseField name="rename" type={<><span><a href="#nesrenameactioncapabilities">NesRenameActionCapabilities</a></span><span> | null</span></>} >
  Whether the client supports the `rename` suggestion kind.
</ResponseField>
<ResponseField name="searchAndReplace" type={<><span><a href="#nessearchandreplaceactioncapabilities">NesSearchAndReplaceActionCapabilities</a></span><span> | null</span></>} >
