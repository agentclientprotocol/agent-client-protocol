...
<ResponseField name="configOptions" type={"array | null"} >
  **UNSTABLE**
...
<ResponseField name="sessions" type={<><span><a href="#sessioninfo">SessionInfo</a></span><span>[]</span></>} required>
...
<ResponseField name="configOptions" type={<><span><a href="#sessionconfigoption">SessionConfigOption</a></span><span>[]</span></>} required>
...
<ResponseField name="options" type={<><span><a href="#sessionconfigselectoption">SessionConfigSelectOption</a></span><span>[]</span></>} required>
...
<ResponseField name="availableModels" type={<><span><a href="#modelinfo">ModelInfo</a></span><span>[]</span></>} required>
