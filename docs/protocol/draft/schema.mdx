...
#### <span class="font-mono">NesCloseRequest</span>
...
#### <span class="font-mono">NesCloseResponse</span>
...
<ResponseField
  ...
  type={
    <>
      <span>
        <a href="#nesjumpcapabilities">NesJumpCapabilities</a>
      </span>
      <span> | null</span>
    </>
  }
...
<ResponseField
  name="syncKind"
  type={<a href="#textdocumentsynckind">TextDocumentSyncKind</a>}
  required
>
...
## <span class="font-mono">NesRenameActionSuggestion</span>
...
## <span class="font-mono">NesSearchAndReplaceActionSuggestion</span>
