...
- 2026-06-05: Recorded the v2 capability cleanup: unified initialize capability fields, shorter capability group names, `session.load`, object-shaped support markers, explicit `mcp.stdio`, and removal of deprecated MCP SSE transport.
