...
```typescript
/**
 * Well-known LLM protocol identifiers.
 * Each identifier represents an API compatibility level, not a specific vendor.
 ...
 */
type LlmProtocol = "anthropic" | "openai" | "google" | "amazon" | "will be added later";
...
### How should protocol identifiers be standardized?

We need to define a standard set of LLM protocol identifiers (e.g., `"anthropic"`, `"openai"`, `"google"`, `"amazon"`). Should this be:
