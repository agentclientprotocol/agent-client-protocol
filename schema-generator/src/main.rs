    ...
    impl SideDocs {
        fn agent_method_doc(&self, method_name: &str) -> &String {
            match method_name {
                ...
                "providers/list_api" => self.agent.get("ListApiProvidersRequest").unwrap(),
                "providers/configure" => self.agent.get("ConfigureProvidersRequest").unwrap(),
                "providers/restore" => self.agent.get("RestoreProvidersRequest").unwrap(),
